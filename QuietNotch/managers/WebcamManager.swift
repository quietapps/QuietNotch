...
class WebcamManager: NSObject, ObservableObject {
    ...
    private let sessionQueue = DispatchQueue(label: "QuietNotch.WebcamManager.SessionQueue", qos: .userInitiated)
        ...
        sessionQueue.async { [weak self] in
            ...
            do {
                ...
                guard session.canAddInput(videoInput) else {
                    throw NSError(domain: "QuietNotch.WebcamManager", code: -1, userInfo: [NSLocalizedDescriptionKey: "Cannot add video input"])
                }
