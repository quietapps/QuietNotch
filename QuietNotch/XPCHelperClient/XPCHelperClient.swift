...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "app.quiet.QuietNotch.QuietNotchXPCHelper"
    
    private var remoteService: RemoteXPCService<QuietNotchXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<QuietNotchXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<QuietNotchXPCHelperProtocol>(
            connection: conn,
            remoteInterface: QuietNotchXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<QuietNotchXPCHelperProtocol>? {
        remoteService
    }
