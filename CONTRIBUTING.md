...
You can contribute in many ways: writing code, improving documentation, reporting bugs, requesting features, or creating tutorials and blog posts. Every contribution, large or small, helps make Quiet Notch better.
...
Please submit all translations to [Crowdin](https://crowdin.com/project/quiet-notch). New strings added to the `dev` branch from code changes will sync automatically to Crowdin, and Crowdin will automatically open a new PR with translations to allow us to integrate them.
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/{your-username}/quiet.notch.git
   cd quiet.notch
   ```
...
- Join our [community Discord server](https://discord.com/servers/quiet-notch-1269588937320566815)

---

Thank you for contributing to Quiet Notch! Your efforts help make this project better for everyone. 🎉
